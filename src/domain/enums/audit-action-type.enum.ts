...
export const AuditActionTypeLabels: Record<AuditActionType, string> = {
  ...
  [AuditActionType.FILE_DOWNLOADED]: 'File Downloaded',
  [AuditActionType.FILE_UPLOAD_FAILED]: 'File Upload Failed',
  [AuditActionType.FILE_DELETE_FAILED]: 'File Delete Failed',
